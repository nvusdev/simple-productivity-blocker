...
class TestSubsystemStability(unittest.TestCase):
    ...
    def test_detect_conflicting_services_found(self, mock_process_iter, mock_net_conns):
    ...
    @patch('psutil.net_connections')
    @patch('psutil.process_iter')
    @patch('core.platform_handler.detect_security_appliances')
    def test_detect_conflicting_services_not_found(self, mock_platform_detect, mock_process_iter, mock_net_conns):
        ...
        mock_process_iter.return_value = [mock_proc]
        mock_platform_detect.return_value = None
