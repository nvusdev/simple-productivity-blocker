      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
        <div className="text-left">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/5 text-emerald-500 text-xs font-semibold mb-6"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-emerald-500 text-zinc-950 px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(16,185,129,0.2)]"
            >
        ...
        <div className="relative">
          ...
          >
               ...
               <div className="rounded-xl border border-zinc-800 bg-zinc-950/50 overflow-hidden aspect-[16/10] relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
                    ...
                    <motion.div 
                      ...
                      className="absolute left-0 right-0 h-[1px] bg-emerald-500/30 blur-[2px] z-10 pointer-events-none"
                    />
                  </div>
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 px-4 py-2 rounded-lg bg-zinc-900 border border-zinc-800 shadow-xl text-xs font-mono text-emerald-500"
            >
              STATUS: HARDENED
            </motion.div>
